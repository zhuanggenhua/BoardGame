...
const loadRuntime3 = async (): Promise<GameClientRuntimeModule> => {
    ...
    return {
        ...
        board: requireLazyModuleExport(boardModule, 'default', './betrayal/Board'),
...
const loadRuntime6 = async (): Promise<GameClientRuntimeModule> => {
    ...
    return {
        engineConfig: gameModule.engineConfig,
        board: requireLazyModuleExport(boardModule, 'default', './fantasyrealms/Board'),
        audioConfig: gameModule.audioConfig,
    };
};
...
const loadRuntime12 = async (): Promise<GameClientRuntimeModule> => {
    ...
    return {
        engineConfig: gameModule.engineConfig,
        board: requireLazyModuleExport(boardModule, 'default', './the-gang/Board'),
        audioConfig: gameModule.audioConfig,
    };
};
