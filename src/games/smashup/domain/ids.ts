...
export const SMASHUP_ATLAS_IDS = {
    ...
    DISCO_DANCERS_POD_CARDS: 'smashup:disco-dancers-pod-cards',
    ...
    TEDDY_BEARS_POD_CARDS: 'smashup:teddy-bears-pod-cards',
    ANCIENT_INCAS_POD_CARDS: 'smashup:ancient-incas-pod-cards',
...
export const SMASHUP_FACTION_IDS = {
    ...
    DISCO_DANCERS_POD: 'disco_dancers_pod',
    HULUWAWA: 'huluwawa',
    ...
    TEDDY_BEARS_POD: 'teddy_bears_pod',
    GRANNIES: 'grannies',
    PIRATES: 'pirates',
...
export const FACTION_DISPLAY_NAMES: Record<string, string> = {
    ...
    [SMASHUP_FACTION_IDS.DISCO_DANCERS_POD]: '迪厅舞王 (POD版)',
    ...
    [SMASHUP_FACTION_IDS.TEDDY_BEARS_POD]: '泰迪熊 (POD版)',
