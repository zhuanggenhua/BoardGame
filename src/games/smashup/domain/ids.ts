...
export const SMASHUP_ATLAS_IDS = {
    ...
    DRAGONS_POD: 'smashup:dragons-pod-cards',
    SUPERHEROES_POD: 'smashup:superheroes-pod-cards',
    MAGICAL_GIRLS_POD: 'smashup:magical-girls-pod-cards',
    MEGA_TROOPERS_POD: 'smashup:mega-troopers-pod-cards',
