...
export const SMASHUP_ATLAS_DEFINITIONS: readonly SmashUpAtlasDefinition[] = [
    ...
    { id: SMASHUP_ATLAS_IDS.CARDS10, kind: 'card', image: 'smashup/cards/yuanhou', grid: { rows: 6, cols: 8 } },
    ...
    { id: SMASHUP_ATLAS_IDS.BASE8, kind: 'base', image: 'smashup/base/yuanhou', grid: { rows: 2, cols: 4 } },
];
