...
export const SMASHUP_ATLAS_DEFINITIONS: readonly SmashUpAtlasDefinition[] = [
    ...
    { id: SMASHUP_ATLAS_IDS.ASTROKNIGHTS_POD_CARDS, kind: 'card', image: 'smashup/cards/astroknights_pod', grid: { rows: 4, cols: 5 } },
    ...
    { id: SMASHUP_ATLAS_IDS.ACTION_HEROES_POD_CARDS, kind: 'card', image: 'smashup/cards/action_heroes_pod', grid: { rows: 4, cols: 5 } },
    { id: SMASHUP_ATLAS_IDS.DIY_KILLERS_CARDS, kind: 'card', image: 'smashup/cards/diy_killers', grid: { rows: 4, cols: 5 } },
    { id: SMASHUP_ATLAS_IDS.DIY_CLOWNS_CARDS, kind: 'card', image: 'smashup/cards/diy_clowns', grid: { rows: 4, cols: 5 } },
    { id: SMASHUP_ATLAS_IDS.HALF_THE_BATTLE_GECKOS_CARDS, kind: 'card', image: 'smashup/cards/half_the_battle_geckos', grid: { rows: 4, cols: 5 } },
    { id: SMASHUP_ATLAS_IDS.HALF_THE_BATTLE_GERALD_CARDS, kind: 'card', image: 'smashup/cards/half_the_battle_gerald', grid: { rows: 4, cols: 5 } },
    { id: SMASHUP_ATLAS_IDS.HALF_THE_BATTLE_COSMOS_CARDS, kind: 'card', image: 'smashup/cards/half_the_battle_cosmos', grid: { rows: 4, cols: 5 } },
    { id: SMASHUP_ATLAS_IDS.HALF_THE_BATTLE_PEARL_IMAGES_CARDS, kind: 'card', image: 'smashup/cards/half_the_battle_pearl_images', grid: { rows: 4, cols: 5 } },
    ...
    { id: SMASHUP_ATLAS_IDS.ROUND_TABLE_KNIGHTS_CARDS, kind: 'card', image: 'smashup/cards/round_table_knights', grid: { rows: 4, cols: 5 } },
    { id: SMASHUP_ATLAS_IDS.GOBLINS_CARDS, kind: 'card', image: 'smashup/cards/goblins', grid: { rows: 4, cols: 5 } },
    { id: SMASHUP_ATLAS_IDS.MUNCHKIN_DWARVES_CARDS, kind: 'card', image: 'smashup/cards/munchkin_dwarves', grid: { rows: 4, cols: 5 } },
    { id: SMASHUP_ATLAS_IDS.MUNCHKIN_HALFLINGS_CARDS, kind: 'card', image: 'smashup/cards/munchkin_halflings', grid: { rows: 4, cols: 5 } },
    { id: SMASHUP_ATLAS_IDS.MUNCHKIN_THIEVES_CARDS, kind: 'card', image: 'smashup/cards/munchkin_thieves', grid: { rows: 4, cols: 5 } },
    { id: SMASHUP_ATLAS_IDS.MUNCHKIN_MAGES_CARDS, kind: 'card', image: 'smashup/cards/munchkin_mages', grid: { rows: 4, cols: 5 } },
    { id: SMASHUP_ATLAS_IDS.MUNCHKIN_ELVES_CARDS, kind: 'card', image: 'smashup/cards/munchkin_elves', grid: { rows: 4, cols: 5 } },
    { id: SMASHUP_ATLAS_IDS.MUNCHKIN_CLERICS_CARDS, kind: 'card', image: 'smashup/cards/munchkin_clerics', grid: { rows: 4, cols: 5 } },
    { id: SMASHUP_ATLAS_IDS.MUNCHKIN_ORCS_CARDS, kind: 'card', image: 'smashup/cards/munchkin_orcs', grid: { rows: 4, cols: 5 } },
    { id: SMASHUP_ATLAS_IDS.MUNCHKIN_WARRIORS_CARDS, kind: 'card', image: 'smashup/cards/munchkin_warriors', grid: { rows: 4, cols: 5 } },
    ...
    { id: SMASHUP_ATLAS_IDS.DISCO_DANCERS_POD_CARDS, kind: 'card', image: 'smashup/cards/disco_dancers_pod', grid: { rows: 4, cols: 5 } },
    ...
    { id: SMASHUP_ATLAS_IDS.ANCIENT_INCAS_POD_CARDS, kind: 'card', image: 'smashup/cards/ancient_incas_pod', grid: { rows: 4, cols: 5 } },
    { id: SMASHUP_ATLAS_IDS.TEDDY_BEARS_POD_CARDS, kind: 'card', image: 'smashup/cards/teddy_bears_pod', grid: { rows: 4, cols: 5 } },
    ...
    { id: SMASHUP_ATLAS_IDS.DIY_CLOWNS_BASES, kind: 'base', image: 'smashup/base/diy_clowns_bases', grid: { rows: 1, cols: 2 } },
    ...
    { id: SMASHUP_ATLAS_IDS.ROUND_TABLE_KNIGHTS_BASES, kind: 'base', image: 'smashup/base/round_table_knights_bases', grid: { rows: 1, cols: 2 } },
    { id: SMASHUP_ATLAS_IDS.GOBLINS_BASES, kind: 'base', image: 'smashup/base/goblins_bases', grid: { rows: 1, cols: 2 } },
    { id: SMASHUP_ATLAS_IDS.MUNCHKIN_DWARVES_BASES, kind: 'base', image: 'smashup/base/munchkin_dwarves_bases', grid: { rows: 1, cols: 2 } },
    { id: SMASHUP_ATLAS_IDS.MUNCHKIN_HALFLINGS_BASES, kind: 'base', image: 'smashup/base/munchkin_halflings_bases', grid: { rows: 1, cols: 2 } },
    { id: SMASHUP_ATLAS_IDS.MUNCHKIN_THIEVES_BASES, kind: 'base', image: 'smashup/base/munchkin_thieves_bases', grid: { rows: 1, cols: 2 } },
    { id: SMASHUP_ATLAS_IDS.MUNCHKIN_MAGES_BASES, kind: 'base', image: 'smashup/base/munchkin_mages_bases', grid: { rows: 1, cols: 2 } },
    { id: SMASHUP_ATLAS_IDS.MUNCHKIN_ELVES_BASES, kind: 'base', image: 'smashup/base/munchkin_elves_bases', grid: { rows: 1, cols: 2 } },
    { id: SMASHUP_ATLAS_IDS.MUNCHKIN_CLERICS_BASES, kind: 'base', image: 'smashup/base/munchkin_clerics_bases', grid: { rows: 1, cols: 2 } },
    { id: SMASHUP_ATLAS_IDS.MUNCHKIN_ORCS_BASES, kind: 'base', image: 'smashup/base/munchkin_orcs_bases', grid: { rows: 1, cols: 2 } },
    { id: SMASHUP_ATLAS_IDS.MUNCHKIN_WARRIORS_BASES, kind: 'base', image: 'smashup/base/munchkin_warriors_bases', grid: { rows: 1, cols: 2 } },
];
