...
export const SU_EVENTS = defineEvents({
  ...
  'su:munchkin_monster_played': { audio: 'immediate', sound: MINION_PLAY_KEY },
  'su:munchkin_monster_to_deck_bottom': { audio: 'immediate', sound: CARD_SCROLL_KEY },
  'su:munchkin_monster_control_changed': { audio: 'immediate', sound: MOVE_KEY },
  'su:munchkin_treasures_drawn': { audio: 'immediate', sound: CARD_DRAW_KEY },
  'su:munchkin_treasures_milled': { audio: 'immediate', sound: CARD_DISCARD_KEY },
  'su:munchkin_treasure_recovered_from_discard': { audio: 'immediate', sound: CARD_DRAW_KEY },
  'su:munchkin_treasure_found_from_deck': { audio: 'immediate', sound: CARD_DRAW_KEY },
  'su:munchkin_treasure_reward_revealed': { audio: 'immediate', sound: CARD_SCROLL_KEY },
  'su:munchkin_treasure_reward_claimed': { audio: 'immediate', sound: CARD_DRAW_KEY },
  'su:munchkin_treasure_reward_distributed': { audio: 'immediate', sound: CARD_DRAW_KEY },
  'su:munchkin_treasure_deck_shuffled': { audio: 'immediate', sound: CARD_SHUFFLE_KEY },
  'su:munchkin_treasure_to_deck_bottom': { audio: 'immediate', sound: CARD_SCROLL_KEY },
...
export const SU_EVENT_TYPES = {
  ...
  MUNCHKIN_MONSTER_PLAYED: SU_EVENTS['su:munchkin_monster_played'].type,
  MUNCHKIN_MONSTER_TO_DECK_BOTTOM: SU_EVENTS['su:munchkin_monster_to_deck_bottom'].type,
  MUNCHKIN_MONSTER_CONTROL_CHANGED: SU_EVENTS['su:munchkin_monster_control_changed'].type,
  MUNCHKIN_TREASURES_DRAWN: SU_EVENTS['su:munchkin_treasures_drawn'].type,
  MUNCHKIN_TREASURES_MILLED: SU_EVENTS['su:munchkin_treasures_milled'].type,
  MUNCHKIN_TREASURE_RECOVERED_FROM_DISCARD: SU_EVENTS['su:munchkin_treasure_recovered_from_discard'].type,
  MUNCHKIN_TREASURE_FOUND_FROM_DECK: SU_EVENTS['su:munchkin_treasure_found_from_deck'].type,
  MUNCHKIN_TREASURE_REWARD_REVEALED: SU_EVENTS['su:munchkin_treasure_reward_revealed'].type,
  MUNCHKIN_TREASURE_REWARD_CLAIMED: SU_EVENTS['su:munchkin_treasure_reward_claimed'].type,
  MUNCHKIN_TREASURE_REWARD_DISTRIBUTED: SU_EVENTS['su:munchkin_treasure_reward_distributed'].type,
  MUNCHKIN_TREASURE_DECK_SHUFFLED: SU_EVENTS['su:munchkin_treasure_deck_shuffled'].type,
  MUNCHKIN_TREASURE_TO_DECK_BOTTOM: SU_EVENTS['su:munchkin_treasure_to_deck_bottom'].type,
