...
export const FACTION_METADATA: FactionMeta[] = [
    ...
    { id: SMASHUP_FACTION_IDS.RUSSIAN_FAIRY_TALES_POD, nameKey: 'factions.russian_fairy_tales_pod.name', icon: Flower2, color: '#475569', descriptionKey: 'factions.russian_fairy_tales_pod.description' },
