...
export const FACTION_METADATA: FactionMeta[] = [
    ...
    { id: SMASHUP_FACTION_IDS.KUNG_FU_FIGHTERS, nameKey: 'factions.kung_fu_fighters.name', icon: Sword, color: '#b45309', descriptionKey: 'factions.kung_fu_fighters.description', implementationStatus: 'in_progress', locales: ['zh-CN'] },
    { id: SMASHUP_FACTION_IDS.VIGILANTES, nameKey: 'factions.vigilantes.name', icon: Eye, color: '#334155', descriptionKey: 'factions.vigilantes.description', implementationStatus: 'in_progress', locales: ['zh-CN'] },
    { id: SMASHUP_FACTION_IDS.TRUCKERS, nameKey: 'factions.truckers.name', icon: Cog, color: '#ea580c', descriptionKey: 'factions.truckers.description', implementationStatus: 'in_progress', locales: ['zh-CN'] },
    { id: SMASHUP_FACTION_IDS.DISCO_DANCERS, nameKey: 'factions.disco_dancers.name', icon: Theater, color: '#0d9488', descriptionKey: 'factions.disco_dancers.description', implementationStatus: 'in_progress', locales: ['zh-CN'] },
    ...
    { id: SMASHUP_FACTION_IDS.ITTY_CRITTERS, nameKey: 'factions.itty_critters.name', icon: PawPrint, color: '#facc15', descriptionKey: 'factions.itty_critters.description' },
