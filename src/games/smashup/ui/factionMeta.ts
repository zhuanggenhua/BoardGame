...
export const FACTION_METADATA: FactionMeta[] = [
    ...
    { id: SMASHUP_FACTION_IDS.ACTION_HEROES, nameKey: 'factions.action_heroes.name', icon: Medal, color: '#dc2626', descriptionKey: 'factions.action_heroes.description', implementationStatus: 'in_progress', locales: ['zh-CN'] },
    { id: SMASHUP_FACTION_IDS.BACKTIMERS, nameKey: 'factions.backtimers.name', icon: Orbit, color: '#0d9488', descriptionKey: 'factions.backtimers.description', implementationStatus: 'in_progress', locales: ['zh-CN'] },
    { id: SMASHUP_FACTION_IDS.EXTRAMORPHS, nameKey: 'factions.extramorphs.name', icon: OctopusHeadIcon, color: '#16a34a', descriptionKey: 'factions.extramorphs.description', implementationStatus: 'in_progress', locales: ['zh-CN'] },
    { id: SMASHUP_FACTION_IDS.TEENS, nameKey: 'factions.teens.name', icon: Theater, color: '#db2777', descriptionKey: 'factions.teens.description', implementationStatus: 'in_progress', locales: ['zh-CN'] },
    { id: SMASHUP_FACTION_IDS.WRAITHRUSTLERS, nameKey: 'factions.wraithrustlers.name', icon: Ghost, color: '#7c3aed', descriptionKey: 'factions.wraithrustlers.description', implementationStatus: 'in_progress', locales: ['zh-CN'] },
    ...
    {
        id: SMASHUP_FACTION_IDS.NEW_ROUND_TABLE_KNIGHTS,
        nameKey: 'factions.new_round_table_knights.name',
        icon: Shield,
        color: '#b45309',
    ...
    },
    {
        ...
        nameKey: 'factions.new_goblins.name',
        icon: Theater,
        color: '#16a34a',
        descriptionKey: 'factions.new_goblins.description',
    ...
    { id: SMASHUP_FACTION_IDS.DIY_KILLERS, nameKey: 'factions.diy_killers.name', icon: Skull, color: '#991b1b', descriptionKey: 'factions.diy_killers.description', implementationStatus: 'in_progress', locales: ['zh-CN'], expansion: 'diy' },
    { id: SMASHUP_FACTION_IDS.DIY_CLOWNS, nameKey: 'factions.diy_clowns.name', icon: Theater, color: '#e11d48', descriptionKey: 'factions.diy_clowns.description', implementationStatus: 'in_progress', locales: ['zh-CN'], expansion: 'diy' },
    ...
    { id: SMASHUP_FACTION_IDS.ADOLESCENT_EPIC_GECKOS, nameKey: 'factions.adolescent_epic_geckos.name', icon: ShurikenIcon, color: '#16a34a', descriptionKey: 'factions.adolescent_epic_geckos.description', implementationStatus: 'in_progress' },
    { id: SMASHUP_FACTION_IDS.GI_GERALD, nameKey: 'factions.gi_gerald.name', icon: Shield, color: '#2563eb', descriptionKey: 'factions.gi_gerald.description', implementationStatus: 'in_progress' },
    { id: SMASHUP_FACTION_IDS.RULERS_OF_THE_COSMOS, nameKey: 'factions.rulers_of_the_cosmos.name', icon: Sword, color: '#f59e0b', descriptionKey: 'factions.rulers_of_the_cosmos.description', implementationStatus: 'in_progress' },
    { id: SMASHUP_FACTION_IDS.PEARL_AND_THE_IMAGES, nameKey: 'factions.pearl_and_the_images.name', icon: Theater, color: '#db2777', descriptionKey: 'factions.pearl_and_the_images.description', implementationStatus: 'in_progress' },
    ...
    { id: SMASHUP_FACTION_IDS.BIG_HERO_6, nameKey: 'factions.big_hero_6.name', icon: Bot, color: '#dc2626', descriptionKey: 'factions.big_hero_6.description', mechanicRule: POWER_COUNTER_MECHANIC_RULE },
    { id: SMASHUP_FACTION_IDS.FROZEN, nameKey: 'factions.frozen.name', icon: Snowflake, color: '#0ea5e9', descriptionKey: 'factions.frozen.description' },
    { id: SMASHUP_FACTION_IDS.LION_KING, nameKey: 'factions.lion_king.name', icon: PawPrint, color: '#f59e0b', descriptionKey: 'factions.lion_king.description', mechanicRule: POWER_COUNTER_MECHANIC_RULE },
    { id: SMASHUP_FACTION_IDS.MULAN, nameKey: 'factions.mulan.name', icon: Sword, color: '#b91c1c', descriptionKey: 'factions.mulan.description', mechanicRule: POWER_COUNTER_MECHANIC_RULE },
