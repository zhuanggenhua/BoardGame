...
export const FACTION_METADATA: FactionMeta[] = [
    ...
    { id: SMASHUP_FACTION_IDS.TEDDY_BEARS_POD, nameKey: 'factions.teddy_bears_pod.name', icon: PawPrint, color: '#c084fc', descriptionKey: 'factions.teddy_bears_pod.description' },
    ...
    {
        id: SMASHUP_FACTION_IDS.DISCO_DANCERS_POD,
        nameKey: 'factions.disco_dancers_pod.name',
        icon: Disc3,
        color: '#0d9488',
        descriptionKey: 'factions.disco_dancers_pod.description',
    },
