...
export const FACTION_METADATA: FactionMeta[] = [
    ...
    { id: SMASHUP_FACTION_IDS.GI_GERALD, nameKey: 'factions.gi_gerald.name', icon: Shield, color: '#2563eb', descriptionKey: 'factions.gi_gerald.description' },
    { id: SMASHUP_FACTION_IDS.RULERS_OF_THE_COSMOS, nameKey: 'factions.rulers_of_the_cosmos.name', icon: Sword, color: '#f59e0b', descriptionKey: 'factions.rulers_of_the_cosmos.description' },
    { id: SMASHUP_FACTION_IDS.PEARL_AND_THE_IMAGES, nameKey: 'factions.pearl_and_the_images.name', icon: Theater, color: '#db2777', descriptionKey: 'factions.pearl_and_the_images.description' },
