...
export const FACTION_METADATA: FactionMeta[] = [
    ...
    { id: SMASHUP_FACTION_IDS.PIRATES_POD, nameKey: 'factions.pirates_pod.name', icon: Anchor, color: '#1e293b', descriptionKey: 'factions.pirates_pod.description', devOnly: true },
    ...
    { id: SMASHUP_FACTION_IDS.DINOSAURS_POD, nameKey: 'factions.dinosaurs_pod.name', icon: Bone, color: '#15803d', descriptionKey: 'factions.dinosaurs_pod.description', devOnly: true },
    ...
    { id: SMASHUP_FACTION_IDS.ALIENS_POD, nameKey: 'factions.aliens_pod.name', icon: Orbit, color: '#0ea5e9', descriptionKey: 'factions.aliens_pod.description', devOnly: true },
    ...
    { id: SMASHUP_FACTION_IDS.ROBOTS_POD, nameKey: 'factions.robots_pod.name', icon: Bot, color: '#475569', descriptionKey: 'factions.robots_pod.description', devOnly: true },
    ...
    { id: SMASHUP_FACTION_IDS.ZOMBIES_POD, nameKey: 'factions.zombies_pod.name', icon: Skull, color: '#10b981', descriptionKey: 'factions.zombies_pod.description', devOnly: true },
    ...
    { id: SMASHUP_FACTION_IDS.WIZARDS_POD, nameKey: 'factions.wizards_pod.name', icon: Wand2, color: '#8b5cf6', descriptionKey: 'factions.wizards_pod.description', devOnly: true },
    ...
    { id: SMASHUP_FACTION_IDS.TRICKSTERS_POD, nameKey: 'factions.tricksters_pod.name', icon: Theater, color: '#f59e0b', descriptionKey: 'factions.tricksters_pod.description', devOnly: true },
    ...
    { id: SMASHUP_FACTION_IDS.STEAMPUNKS_POD, nameKey: 'factions.steampunks_pod.name', icon: Cog, color: '#b45309', descriptionKey: 'factions.steampunks_pod.description', devOnly: true },
    ...
    { id: SMASHUP_FACTION_IDS.GHOSTS_POD, nameKey: 'factions.ghosts_pod.name', icon: Ghost, color: '#fca5a5', descriptionKey: 'factions.ghosts_pod.description', devOnly: true },
    ...
    { id: SMASHUP_FACTION_IDS.KILLER_PLANTS_POD, nameKey: 'factions.killer_plants_pod.name', icon: Sprout, color: '#4d7c0f', descriptionKey: 'factions.killer_plants_pod.description', devOnly: true },
    ...
    { id: SMASHUP_FACTION_IDS.WEREWOLVES_POD, nameKey: 'factions.werewolves_pod.name', icon: Moon, color: '#78716c', descriptionKey: 'factions.werewolves_pod.description', devOnly: true },
