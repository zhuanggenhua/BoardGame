...
import { EXPLORERS_POD_CARDS } from './factions/explorers_pod';
import { STAR_ROAMERS_POD_CARDS } from './factions/star_roamers_pod';
import { VIGILANTES_POD_CARDS } from './factions/vigilantes_pod';
import { LUCHADORS_POD_CARDS } from './factions/luchadors_pod';
...
import { KAIJU_POD_CARDS } from './factions/kaiju_pod';
...
import { AVENGERS_POD_CARDS } from './factions/avengers_pod';
import { SHIELD_CARDS } from './factions/shield';
import { SHIELD_POD_CARDS } from './factions/shield_pod';
import { SPIDER_VERSE_CARDS } from './factions/spider_verse';
import { SPIDER_VERSE_POD_CARDS } from './factions/spider_verse_pod';
import { ULTIMATES_CARDS } from './factions/ultimates';
import { ULTIMATES_POD_CARDS } from './factions/ultimates_pod';
import { HYDRA_CARDS } from './factions/hydra';
import { HYDRA_POD_CARDS } from './factions/hydra_pod';
import { KREE_CARDS } from './factions/kree';
import { KREE_POD_CARDS } from './factions/kree_pod';
import { MASTERS_OF_EVIL_CARDS } from './factions/masters_of_evil';
import { MASTERS_OF_EVIL_POD_CARDS } from './factions/masters_of_evil_pod';
import { SINISTER_SIX_CARDS } from './factions/sinister_six';
import { SINISTER_SIX_POD_CARDS } from './factions/sinister_six_pod';
import { ANANSI_TALES_BASES, ANANSI_TALES_CARDS } from './factions/anansi_tales';
import { ANANSI_TALES_POD_CARDS } from './factions/anansi_tales_pod';
...
import { RUSSIAN_FAIRY_TALES_POD_CARDS } from './factions/russian_fairy_tales_pod';
...
import { PENGUINS_BASES, PENGUINS_CARDS } from './factions/penguins';
...
registerCards(EXPLORERS_POD_CARDS);
...
registerCards(STAR_ROAMERS_POD_CARDS);
...
registerBases(EXCELLENT_MOVIES_TEENS_BASES);
registerBases(DIY_KILLERS_BASES);
registerBases(DIY_CLOWNS_BASES);
registerBases(HALF_THE_BATTLE_BASES);
