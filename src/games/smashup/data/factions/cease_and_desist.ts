...
const ASTROKNIGHTS_CARD_ATLAS = SMASHUP_ATLAS_IDS.ASTROKNIGHTS_POD_CARDS;
...
export const ASTROKNIGHTS_ACTIONS: ActionCardDef[] = [
    { id: 'astroknights_block_the_probe', type: 'action', subtype: 'special', name: '阻止探解', nameEn: 'Block the Probe', faction: ASTROKNIGHTS, abilityTags: ['onPlay', 'special'], specialTiming: 'beforeScoring', count: 2, previewRef: { type: 'atlas', atlasId: ASTROKNIGHTS_CARD_ATLAS, index: 7 } },
    { id: 'astroknights_hidden_base', type: 'action', subtype: 'ongoing', name: '隐蔽基地', nameEn: 'Hidden Base', faction: ASTROKNIGHTS, abilityTags: ['ongoing'], ongoingTarget: 'base', playNeedsBase: true, count: 1, previewRef: { type: 'atlas', atlasId: ASTROKNIGHTS_CARD_ATLAS, index: 6 } },
    { id: 'astroknights_recycle_the_trash', type: 'action', subtype: 'standard', name: '垃圾回收', nameEn: 'Recycle the Trash', faction: ASTROKNIGHTS, abilityTags: ['onPlay'], count: 1, previewRef: { type: 'atlas', atlasId: ASTROKNIGHTS_CARD_ATLAS, index: 2 } },
    { id: 'astroknights_yield_to_rage', type: 'action', subtype: 'standard', name: '狂怒支配', nameEn: 'Yield to Rage', faction: ASTROKNIGHTS, abilityTags: ['onPlay', 'extra'], playNeedsMinion: true, playTargetMinionController: 'self', count: 1, previewRef: { type: 'atlas', atlasId: ASTROKNIGHTS_CARD_ATLAS, index: 5 } },
    { id: 'astroknights_laser_sword', type: 'action', subtype: 'ongoing', name: '激光剑', nameEn: 'Laser Sword', faction: ASTROKNIGHTS, abilityTags: ['ongoing'], ongoingTarget: 'minion', playNeedsMinion: true, playTargetMinionController: 'any', count: 2, previewRef: { type: 'atlas', atlasId: ASTROKNIGHTS_CARD_ATLAS, index: 0 } },
    { id: 'astroknights_prepare_for_battle', type: 'action', subtype: 'standard', name: '战斗准备', nameEn: 'Prepare for Battle', faction: ASTROKNIGHTS, abilityTags: ['onPlay'], count: 1, previewRef: { type: 'atlas', atlasId: ASTROKNIGHTS_CARD_ATLAS, index: 4 } },
    { id: 'astroknights_use_the_fours', type: 'action', subtype: 'standard', name: '使用“似”原力', nameEn: 'Use the Fours', faction: ASTROKNIGHTS, abilityTags: ['onPlay'], playNeedsMinion: true, playTargetMinionController: 'self', count: 1, previewRef: { type: 'atlas', atlasId: ASTROKNIGHTS_CARD_ATLAS, index: 3 } },
    { id: 'astroknights_its_a_trap', type: 'action', subtype: 'special', name: '这是个陷阱！', nameEn: "It's a Trap!", faction: ASTROKNIGHTS, abilityTags: ['special'], specialTiming: 'beforeScoring', count: 1, previewRef: { type: 'atlas', atlasId: ASTROKNIGHTS_CARD_ATLAS, index: 9 } },
];

export const ASTROKNIGHTS_MINIONS: MinionCardDef[] = [
    { id: 'astroknights_annoying_alien', type: 'minion', name: '恼人的外星', nameEn: 'Annoying Alien', faction: ASTROKNIGHTS, power: 2, abilityTags: ['talent'], activatableAbilities: [{ kind: 'talent', zone: 'board', window: 'playCards' }], count: 1, previewRef: { type: 'atlas', atlasId: ASTROKNIGHTS_CARD_ATLAS, index: 10 } },
    { id: 'astroknights_pupoks', type: 'minion', name: '帕伯克人', nameEn: 'Pupoks', faction: ASTROKNIGHTS, power: 2, abilityTags: ['talent', 'extra'], activatableAbilities: [{ kind: 'talent', zone: 'board', window: 'playCards' }], count: 1, previewRef: { type: 'atlas', atlasId: ASTROKNIGHTS_CARD_ATLAS, index: 11 } },
    { id: 'astroknights_alien_guru', type: 'minion', name: '外星人大师', nameEn: 'Alien Guru', faction: ASTROKNIGHTS, power: 2, abilityTags: ['ongoing'], count: 1, previewRef: { type: 'atlas', atlasId: ASTROKNIGHTS_CARD_ATLAS, index: 12 } },
    { id: 'astroknights_walking_carpet', type: 'minion', name: '自主地毯', nameEn: 'Walking Carpet', faction: ASTROKNIGHTS, power: 4, abilityTags: ['special'], beforeScoringPlayable: false, activatableAbilities: [{ kind: 'special', zone: 'board', window: 'beforeScoring', sourceScope: 'scoringBase' }], count: 1, previewRef: { type: 'atlas', atlasId: ASTROKNIGHTS_CARD_ATLAS, index: 16 } },
    { id: 'astroknights_scoundrel', type: 'minion', name: '恶棍', nameEn: 'Scoundrel', faction: ASTROKNIGHTS, power: 4, abilityTags: ['talent'], activatableAbilities: [{ kind: 'talent', zone: 'board', window: 'playCards' }], count: 1, previewRef: { type: 'atlas', atlasId: ASTROKNIGHTS_CARD_ATLAS, index: 17 } },
    { id: 'astroknights_ghost_knight', type: 'minion', name: '幽灵武士', nameEn: 'Ghost Knight', faction: ASTROKNIGHTS, power: 0, abilityTags: ['ongoing'], count: 1, previewRef: { type: 'atlas', atlasId: ASTROKNIGHTS_CARD_ATLAS, index: 13 } },
    { id: 'astroknights_mannersbot', type: 'minion', name: '礼仪机器人', nameEn: 'Mannersbot', faction: ASTROKNIGHTS, power: 2, abilityTags: ['talent'], activatableAbilities: [{ kind: 'talent', zone: 'board', window: 'playCards' }], count: 1, previewRef: { type: 'atlas', atlasId: ASTROKNIGHTS_CARD_ATLAS, index: 14 } },
    { id: 'astroknights_space_prince', type: 'minion', name: '太空王子', nameEn: 'Space Prince', faction: ASTROKNIGHTS, power: 4, abilityTags: ['talent', 'extra'], activatableAbilities: [{ kind: 'talent', zone: 'board', window: 'playCards' }], count: 1, previewRef: { type: 'atlas', atlasId: ASTROKNIGHTS_CARD_ATLAS, index: 18 } },
    { id: 'astroknights_space_knight', type: 'minion', name: '太空武士', nameEn: 'Space Knight', faction: ASTROKNIGHTS, power: 5, abilityTags: ['talent'], activatableAbilities: [{ kind: 'talent', zone: 'board', window: 'playCards' }], count: 1, previewRef: { type: 'atlas', atlasId: ASTROKNIGHTS_CARD_ATLAS, index: 19 } },
    { id: 'astroknights_astro_robot', type: 'minion', name: '宇航机器人', nameEn: 'Astro Robot', faction: ASTROKNIGHTS, power: 2, abilityTags: ['onPlay'], count: 1, previewRef: { type: 'atlas', atlasId: ASTROKNIGHTS_CARD_ATLAS, index: 15 } },
];
