...
export const LION_KING_MINIONS: MinionCardDef[] = [
    ...
    { id: 'lion_king_zazu', type: 'minion', name: '沙祖', nameEn: 'Zazu', faction: FACTION, power: 3, abilityTags: ['talent'], activatableAbilities: [{ kind: 'talent', zone: 'board', window: 'playCards' }], count: 1, previewRef: { type: 'atlas', atlasId: CARD_ATLAS, index: 33 } },
...
export const LION_KING_ACTIONS: ActionCardDef[] = [
    ...
    { id: 'lion_king_hyenas_den', type: 'action', subtype: 'ongoing', name: '鬣狗巢穴', nameEn: "Hyena's Den", faction: FACTION, abilityTags: ['ongoing', 'special', 'talent'], ongoingTarget: 'base', playNeedsBase: true, activatableAbilities: [{ kind: 'talent', zone: 'board', window: 'playCards' }, { kind: 'special', zone: 'board', window: 'afterScoring', sourceScope: 'scoringBase' }], count: 1, previewRef: { type: 'atlas', atlasId: CARD_ATLAS, index: 40 } },
