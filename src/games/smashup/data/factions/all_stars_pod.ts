...
export const ALL_STARS_POD_MINIONS: MinionCardDef[] = [
    ...
    { id: 'all_stars_ensign_pod', type: 'minion', name: '少尉', nameEn: 'Ensign', faction: ALL_STARS_POD_FACTION, power: 2, count: 1, previewRef: { type: 'atlas', atlasId: ALL_STARS_POD_ATLAS, index: 13 } },
