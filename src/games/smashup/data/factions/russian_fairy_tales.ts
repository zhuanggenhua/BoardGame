...
export const RUSSIAN_FAIRY_TALES_MINIONS: MinionCardDef[] = [
    {
        id: 'russian_fairy_tales_the_birch_woman',
        type: 'minion',
        name: '白桦木女神',
...
export const RUSSIAN_FAIRY_TALES_ACTIONS: ActionCardDef[] = [
    {
        id: 'russian_fairy_tales_the_frog_princess',
        type: 'action',
        subtype: 'ongoing',
        name: '青蛙公主',
...
export const RUSSIAN_FAIRY_TALES_CARDS: CardDef[] = [
    ...RUSSIAN_FAIRY_TALES_MINIONS,
    ...RUSSIAN_FAIRY_TALES_ACTIONS,
];

export const RUSSIAN_FAIRY_TALES_BASES: BaseCardDef[] = [
    {
        id: 'base_transformation_spring',
        name: '变形之泉',
        nameEn: 'Transformation Spring',
        breakpoint: 19,
        vpAwards: [4, 2, 1],
        faction: FACTION,
