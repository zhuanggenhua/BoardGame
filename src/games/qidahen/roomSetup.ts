...
export const QIDAHEN_SCENARIO_SETUP_OPTIONS = [
    {
        ...
        labelKey: 'games.qidahen.setup.scenario.postSarhu1619',
    },
    {
        value: 'shanhaiguan-1622',
        labelKey: 'games.qidahen.setup.scenario.shanhaiguan1622',
    },
    {
        value: 'dingmao-rebellion-1627',
        labelKey: 'games.qidahen.setup.scenario.dingmaoRebellion1627',
    },
] as const;
...
export const QIDAHEN_PREGAME_CHOICE_FIELDS: readonly QidahenPregameChoiceField[] = [
    createPregameChoiceField(
        ...
        'shanhaiguan-1622',
        'character',
        'games.qidahen.setup.pregameChoices.fields.shanhaiguan1622.mingCharacter',
        [
            { value: 'ming-wang-huazhen', labelKey: 'games.qidahen.setup.pregameChoices.options.mingWangHuazhen' },
            { value: 'ming-xiong-tingbi', labelKey: 'games.qidahen.setup.pregameChoices.options.mingXiongTingbi' },
        ],
    ),
    createPregameChoiceField(
        ...
        'shanhaiguan-1622',
        'character',
        'games.qidahen.setup.pregameChoices.fields.shanhaiguan1622.jinCharacter0',
        [
            { value: 'jin-eidu', labelKey: 'games.qidahen.setup.pregameChoices.options.jinEidu' },
            { value: 'jin-fan-wencheng', labelKey: 'games.qidahen.setup.pregameChoices.options.jinFanWencheng' },
        ],
    ),
    createPregameChoiceField(
        ...
        'shanhaiguan-1622',
        'character',
        'games.qidahen.setup.pregameChoices.fields.shanhaiguan1622.jinCharacter1',
        [
            { value: 'jin-amin', labelKey: 'games.qidahen.setup.pregameChoices.options.jinAmin' },
            { value: 'jin-manggultai', labelKey: 'games.qidahen.setup.pregameChoices.options.jinManggultai' },
        ],
    ),
    createPregameChoiceField(
        ...
        'shanhaiguan-1622',
        'armament',
        'games.qidahen.setup.pregameChoices.fields.shanhaiguan1622.mingArmament0',
        [
            { value: 'cavalry-armor', labelKey: 'games.qidahen.setup.pregameChoices.options.cavalryArmor' },
            { value: 'infantry-armor', labelKey: 'games.qidahen.setup.pregameChoices.options.infantryArmor' },
            { value: 'artillery-tech', labelKey: 'games.qidahen.setup.pregameChoices.options.artilleryTech' },
        ],
    ),
    createPregameChoiceField(
        ...
        'shanhaiguan-1622',
        'armament',
        'games.qidahen.setup.pregameChoices.fields.shanhaiguan1622.mingArmament1',
        [
            { value: 'cavalry-firearm', labelKey: 'games.qidahen.setup.pregameChoices.options.cavalryFirearm' },
            { value: 'long-barreled-musket', labelKey: 'games.qidahen.setup.pregameChoices.options.longBarreledMusket' },
        ],
    ),
    createPregameChoiceField(
        ...
        'character',
        'games.qidahen.setup.pregameChoices.fields.dingmaoRebellion1627.jinCharacter0',
        [
            { value: 'jin-huangtaiji', labelKey: 'games.qidahen.setup.pregameChoices.options.jinHuangtaiji' },
            { value: 'jin-amin', labelKey: 'games.qidahen.setup.pregameChoices.options.jinAmin' },
            { value: 'jin-daisan', labelKey: 'games.qidahen.setup.pregameChoices.options.jinDaisan' },
        ],
    ),
    createPregameChoiceField(
        ...
        'dingmao-rebellion-1627',
        'character',
        'games.qidahen.setup.pregameChoices.fields.dingmaoRebellion1627.jinCharacter1',
        [
            { value: 'jin-yanguli', labelKey: 'games.qidahen.setup.pregameChoices.options.jinYanguli' },
            { value: 'jin-fan-wencheng', labelKey: 'games.qidahen.setup.pregameChoices.options.jinFanWencheng' },
        ],
    ),
    createPregameChoiceField(
        ...
        'dingmao-rebellion-1627',
        'armament',
        'games.qidahen.setup.pregameChoices.fields.dingmaoRebellion1627.mingArmament0',
        [
            { value: 'cavalry-firearm', labelKey: 'games.qidahen.setup.pregameChoices.options.cavalryFirearm' },
            { value: 'long-barreled-musket', labelKey: 'games.qidahen.setup.pregameChoices.options.longBarreledMusket' },
        ],
