...
export const QIDAHEN_GRANT_PARDON_INTERACTION_SOURCE_ID = 'qidahen:grant-pardon';
...
export const QIDAHEN_OPEN_GATE_SURRENDER_INTERACTION_SOURCE_ID = 'qidahen:open-gate-surrender';
export const QIDAHEN_RAID_AND_AMBUSH_INTERACTION_SOURCE_ID = 'qidahen:raid-and-ambush';
export const QIDAHEN_FEIGNED_RETREAT_INTERACTION_SOURCE_ID = 'qidahen:feigned-retreat';
