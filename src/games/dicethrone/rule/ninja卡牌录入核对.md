...
| 21 | `upgrade-shadow-step-2` | 暗影步 II | upgrade / 2CP / main | 升级暗影步 | replace `shadow-step` -> `SHADOW_STEP_2` | L3：真实手牌打出、CP 5->3、`abilityLevels.shadow-step=2` 已测；慢性中毒/烟雾弹后续已有代表覆盖 |
...
| 26 | `upgrade-smoke-screen-2` | 烟雾阵 II | upgrade / 2CP / main | 升级烟雾阵 | replace `smoke-screen` -> `SMOKE_SCREEN_2` | L3：真实手牌打出、CP 5->3、`abilityLevels.smoke-screen=2` 已测；token 后续已有代表覆盖 |
