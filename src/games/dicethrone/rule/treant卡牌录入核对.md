...
| 29 | `upgrade-wild-growth-2` | 野性怒吼 II | `wild-roar` | `WILD_ROAR_2` 当前已按 `大顺子` 触发、`8` 伤害 + `5` 骰奖励落地；基础版 `WILD_ROAR` 同属 `大顺子`，为 `6` 伤害 + `5` 骰奖励 | **2026-07-03 反馈复核后确认：旧“野蛮生长 II / wild-growth”接线结论错误，现已改为升级野性怒吼** |
...
- `upgrade-wild-growth-2` 不是上述同卡双分支结构；2026-07-03 复核后确认它是 `野性怒吼 II`，应升级 `wild-roar`，主触发为 `大顺子`。
