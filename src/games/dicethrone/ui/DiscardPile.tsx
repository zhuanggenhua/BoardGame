...
export const DiscardPile = React.forwardRef<HTMLDivElement, {
    ...
    return (
        ...
        >
            <div
                className={`absolute inset-0 rounded-[0.5vw] border-[0.2vw] border-dashed flex items-center justify-center overflow-hidden shadow-lg transition-[transform,background-color,box-shadow] duration-200 ${
