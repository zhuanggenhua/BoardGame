...
const ABILITY_SLOT_MAP = SHARED_ABILITY_SLOT_MAP;
    ...
    export const AbilityOverlays = React.forwardRef<AbilityOverlaysHandle, AbilityOverlaysProps>(({
        ...
        const highlightOverlayClassName = 'absolute inset-0 rounded-lg ring-[3px] ring-[#ff3347] shadow-[0_0_0_1px_rgba(255,255,255,0.28),0_0_18px_rgba(255,51,71,0.96),0_0_36px_rgba(255,51,71,0.62)] pointer-events-none z-10 animate-pulse';
        const selectedOverlayClassName = 'absolute inset-0 rounded-lg ring-[4px] ring-[#e11d48] shadow-[0_0_0_1px_rgba(255,255,255,0.32),0_0_22px_rgba(225,29,72,0.98),0_0_42px_rgba(225,29,72,0.66)] pointer-events-none z-10';
