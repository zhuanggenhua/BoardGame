...
/** 更新当前 pendingAttack 的局部字段 */
export interface PendingAttackUpdatedEvent extends GameEvent<'PENDING_ATTACK_UPDATED'> {
    payload: {
        attackerId: PlayerId;
        patch: Partial<PendingAttack>;
    };
}
