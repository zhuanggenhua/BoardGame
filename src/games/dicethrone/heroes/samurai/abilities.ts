    ...
    variants: [
        {
            ...
            effects: [
                ...
                custom(
                    'samurai-masamune',
                    abilityEffectText('masamune-2', 'roll5'),
                    'withDamage',
                    { diceCount: 5 },
                ),
            ],
        ...
        },
        {
            ...
            name: abilityText('masamune-2-empower', 'name'),
            description: abilityText('masamune-2-empower', 'description'),
            trigger: { type: 'allSymbolsPresent', symbols: [FACE.KATANA, FACE.HELM, FACE.RISING_SUN] },
            effects: [
                grantToken('self', TOKEN_IDS.SAMURAI_RETRIBUTION, 1, abilityEffectText('masamune-2-empower', 'gainBackStrike'), 'preDefense'),
            ],
            priority: 1,
        },
    ],
