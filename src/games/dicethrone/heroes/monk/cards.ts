...
const ZEN_FORGET_2: AbilityDef = {
    ...
    sfxKey: MONK_SFX_ZEN,
    variants: [
        { id: 'zen-forget-2-zen-combat', trigger: { type: 'diceSet', faces: { [DICE_FACE_IDS.FIST]: 2, [DICE_FACE_IDS.TAIJI]: 2 } }, effects: [damage(6, abilityEffectText('zen-forget-2-zen-combat', 'damage6')), grantToken(TOKEN_IDS.TAIJI, 2, abilityEffectText('zen-forget-2-zen-combat', 'gainTaiji2'), { timing: 'postDamage', condition: { type: 'onHit' } })], priority: 0 },
...
export const MONK_CARDS: AbilityCard[] = [
    ...
    { id: 'card-buddha-light', name: cardText('card-buddha-light', 'name'), type: 'action', cpCost: 3, timing: 'main', description: cardText('card-buddha-light', 'description'), previewRef: { type: 'atlas', atlasId: DICETHRONE_CARD_ATLAS_IDS.MONK, index: 3 }, effects: [grantToken(TOKEN_IDS.TAIJI, 1, cardText('card-buddha-light', 'description'), { timing: 'immediate' }), grantToken(TOKEN_IDS.EVASIVE, 1, cardText('card-buddha-light', 'description'), { timing: 'immediate' }), grantToken(TOKEN_IDS.PURIFY, 1, cardText('card-buddha-light', 'description'), { timing: 'immediate' }), inflictStatus(STATUS_IDS.KNOCKDOWN, 1, cardText('card-buddha-light', 'description'))] },
    { id: 'card-palm-strike', name: cardText('card-palm-strike', 'name'), type: 'action', cpCost: 0, timing: 'main', description: cardText('card-palm-strike', 'description'), previewRef: { type: 'atlas', atlasId: DICETHRONE_CARD_ATLAS_IDS.MONK, index: 4 }, effects: [inflictStatus(STATUS_IDS.KNOCKDOWN, 1, cardText('card-palm-strike', 'description'))] },

    // 升级卡
    { id: 'card-meditation-3', name: cardText('card-meditation-3', 'name'), type: 'upgrade', cpCost: 3, timing: 'main', description: cardText('card-meditation-3', 'description'), previewRef: { type: 'atlas', atlasId: DICETHRONE_CARD_ATLAS_IDS.MONK, index: 5 }, effects: [replaceAbility('meditation', MEDITATION_3, 3, cardText('card-meditation-3', 'description'))] },
    { id: 'card-meditation-2', name: cardText('card-meditation-2', 'name'), type: 'upgrade', cpCost: 2, timing: 'main', description: cardText('card-meditation-2', 'description'), previewRef: { type: 'atlas', atlasId: DICETHRONE_CARD_ATLAS_IDS.MONK, index: 6 }, effects: [replaceAbility('meditation', MEDITATION_2, 2, cardText('card-meditation-2', 'description'))] },
    { id: 'card-zen-fist-2', name: cardText('card-zen-fist-2', 'name'), type: 'upgrade', cpCost: 2, timing: 'main', description: cardText('card-zen-fist-2', 'description'), previewRef: { type: 'atlas', atlasId: DICETHRONE_CARD_ATLAS_IDS.MONK, index: 7 }, effects: [replaceAbility('calm-water', CALM_WATER_2, 2, cardText('card-zen-fist-2', 'description'))] },
    { id: 'card-storm-assault-2', name: cardText('card-storm-assault-2', 'name'), type: 'upgrade', cpCost: 1, timing: 'main', description: cardText('card-storm-assault-2', 'description'), previewRef: { type: 'atlas', atlasId: DICETHRONE_CARD_ATLAS_IDS.MONK, index: 8 }, effects: [replaceAbility('thunder-strike', THUNDER_STRIKE_2, 2, cardText('card-storm-assault-2', 'description'))] },
    { id: 'card-combo-punch-2', name: cardText('card-combo-punch-2', 'name'), type: 'upgrade', cpCost: 2, timing: 'main', description: cardText('card-combo-punch-2', 'description'), previewRef: { type: 'atlas', atlasId: DICETHRONE_CARD_ATLAS_IDS.MONK, index: 9 }, effects: [replaceAbility('taiji-combo', TAIJI_COMBO_2, 2, cardText('card-combo-punch-2', 'description'))] },
    { id: 'card-lotus-bloom-2', name: cardText('card-lotus-bloom-2', 'name'), type: 'upgrade', cpCost: 2, timing: 'main', description: cardText('card-lotus-bloom-2', 'description'), previewRef: { type: 'atlas', atlasId: DICETHRONE_CARD_ATLAS_IDS.MONK, index: 10 }, effects: [replaceAbility('lotus-palm', LOTUS_PALM_2, 2, cardText('card-lotus-bloom-2', 'description'))] },
    { id: 'card-mahayana-2', name: cardText('card-mahayana-2', 'name'), type: 'upgrade', cpCost: 1, timing: 'main', description: cardText('card-mahayana-2', 'description'), previewRef: { type: 'atlas', atlasId: DICETHRONE_CARD_ATLAS_IDS.MONK, index: 11 }, effects: [replaceAbility('harmony', HARMONY_2, 2, cardText('card-mahayana-2', 'description'))] },
    { id: 'card-thrust-punch-2', name: cardText('card-thrust-punch-2', 'name'), type: 'upgrade', cpCost: 2, timing: 'main', description: cardText('card-thrust-punch-2', 'description'), previewRef: { type: 'atlas', atlasId: DICETHRONE_CARD_ATLAS_IDS.MONK, index: 12 }, effects: [replaceAbility('fist-technique', FIST_TECHNIQUE_2, 2, cardText('card-thrust-punch-2', 'description'))] },
    { id: 'card-thrust-punch-3', name: cardText('card-thrust-punch-3', 'name'), type: 'upgrade', cpCost: 2, timing: 'main', description: cardText('card-thrust-punch-3', 'description'), previewRef: { type: 'atlas', atlasId: DICETHRONE_CARD_ATLAS_IDS.MONK, index: 13 }, effects: [replaceAbility('fist-technique', FIST_TECHNIQUE_3, 3, cardText('card-thrust-punch-3', 'description'))] },
    { id: 'card-contemplation-2', name: cardText('card-contemplation-2', 'name'), type: 'upgrade', cpCost: 2, timing: 'main', description: cardText('card-contemplation-2', 'description'), previewRef: { type: 'atlas', atlasId: DICETHRONE_CARD_ATLAS_IDS.MONK, index: 14 }, effects: [replaceAbility('zen-forget', ZEN_FORGET_2, 2, cardText('card-contemplation-2', 'description'))] },
