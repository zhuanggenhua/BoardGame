...
export const MONK_CARDS: AbilityCard[] = [
    ...
    { id: 'card-storm-assault-2', name: cardText('card-storm-assault-2', 'name'), type: 'upgrade', cpCost: 1, timing: 'main', description: cardText('card-storm-assault-2', 'description'), previewRef: { type: 'atlas', atlasId: DICETHRONE_CARD_ATLAS_IDS.MONK, index: 8 }, effects: [replaceAbility('thunder-strike', THUNDER_STRIKE_2, 2, '升级雷霆一击至 II 级')] },
