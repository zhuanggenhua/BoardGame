...
const steelSvgs = {
    ...
    help: `<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><defs><linearGradient id="sh" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#e2e8f0"/><stop offset="100%" stop-color="#94a3b8"/></linearGradient></defs><circle cx="16" cy="16" r="12" fill="url(#sh)" stroke="#334155" stroke-width="2"/><text x="16" y="22" text-anchor="middle" font-size="17" font-weight="bold" font-family="Arial,sans-serif" fill="#334155">?</text></svg>`,
};
...
const runeSvgs = {
    ...
    help: `<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><polygon points="16,2 2,16 16,30 30,16" fill="#1e1b4b" stroke="#818cf8" stroke-width="2"/><text x="16" y="22" text-anchor="middle" font-size="17" font-weight="bold" font-family="Arial,sans-serif" fill="#c7d2fe">?</text></svg>`,
};
...
const etherealSvgs = {
    ...
    help: `<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
        <circle cx="16" cy="16" r="11" fill="rgba(69, 26, 3, 0.5)" stroke="#fbbf24" stroke-width="1.5"/>
        <text x="16" y="22" text-anchor="middle" font-size="17" font-weight="bold" font-family="Arial,sans-serif" fill="#fbbf24">?</text>
    </svg>`
};
