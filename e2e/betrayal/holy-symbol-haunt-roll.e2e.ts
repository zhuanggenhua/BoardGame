...
const createHolySymbolHauntRollCore = () => {
...
const countTeamOmensAfterHolySymbol = (core: ReturnType<typeof createHolySymbolHauntRollCore>) => (
...
test.describe('山屋惊魂圣符作祟判定完整链路', () => {
    test('预兆圣符从探索翻出到作祟检定和关闭回牌桌', async ({ page, context }) => {
        ...
        const expectedDiceCount = countTeamOmensAfterHolySymbol(core);
