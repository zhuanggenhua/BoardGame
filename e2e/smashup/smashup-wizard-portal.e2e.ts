/**
 * SmashUp - Wizard Portal 稳定 E2E
 *
 * Canonical coverage for wizard_portal using the framework-based harness.
 * Promoted from the former `framework-pilot-wizard-portal.e2e.ts` after
 * single-pick / skip / multi-pick flows all had real browser evidence.
 */
...
test.describe('SmashUp Wizard Portal', () => {
