...
2. **数据驱动职责**
   ...
   - **规则真相源优先（强制）**：
     - 只要出现“初始状态 / 开局摆放 / 起始资源 / 起始牌 / 起始房间 / 起始怪物 / 起始目标”，第一步必须先读规则书、剧本文本、组件说明或官方 setup 指令；
...
- [ ] 所有初始状态在设计 owner 前都已回查规则书 / 剧本 / 官方 setup 指令
...
> 新游戏可以先从当前已锁定的规则与素材里，录入“已经足够判断”的必要数据；不需要等所有资料一次性齐全才开工。
