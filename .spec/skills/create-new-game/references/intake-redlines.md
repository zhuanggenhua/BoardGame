...
- **教程完整性是整体完成门槛**：新游戏或现有游戏补完不得在教程缺口未关时标为“整体完成”。必须先按 `.spec/skills/tutorial-workflow/SKILL.md` 和 `.spec/knowledge/standards/tutorial-design.md` 补齐玩家可用元素覆盖矩阵、真实教程 E2E、关键截图核图和未覆盖项说明；`确认 1/2`、聚焦到自己位置/房间/对象、观察视角、状态/进度读法、只读规则入口等非直觉 UI 必须有教程/帮助落点或明确豁免。
