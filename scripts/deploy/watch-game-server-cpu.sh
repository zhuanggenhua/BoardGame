...
THRESHOLD_PERCENT="${BG_GAME_SERVER_CPU_RESTART_THRESHOLD:-140}"
SAMPLE_COUNT="${BG_GAME_SERVER_CPU_SAMPLE_COUNT:-5}"
SAMPLE_INTERVAL_SECONDS="${BG_GAME_SERVER_CPU_SAMPLE_INTERVAL_SECONDS:-30}"
...
Environment:
  ...
  BG_GAME_SERVER_CPU_RESTART_THRESHOLD     sustained CPU percent threshold, default 140
  BG_GAME_SERVER_CPU_SAMPLE_COUNT          sample count, default 5
  BG_GAME_SERVER_CPU_SAMPLE_INTERVAL_SECONDS sample interval, default 30
