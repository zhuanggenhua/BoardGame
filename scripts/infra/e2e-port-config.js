...
export const E2E_SINGLE_WORKER_PORTS = Object.freeze({
  frontend: resolvePort(process.env.PW_PORT || process.env.E2E_PORT, 6173),
  gameServer: resolvePort(process.env.PW_GAME_SERVER_PORT, 20000),
  apiServer: resolvePort(process.env.PW_API_SERVER_PORT, 21000),
});
