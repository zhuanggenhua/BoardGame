...
| Hearthstone 细节 | Mage Wars 旧问题 | v17 裁定 |
| --- | --- | --- |
...
| 筛选是紧凑工具 | 搜索和 4 个 select + 范围按钮组成厚筛选墙；学派下拉一度混入蝙蝠、手套、靴子等子类型 | 保留类型 / 学派或元素 / 等级 / 状态 / 范围，但压成 2.55rem 工具条；学派层只显示正式学派 / 元素词，子类型不得污染该层 |
...
- 默认态不能看到：展开法术书库、管理说明文案、规则说明块、第二个完成区、`当前法术书`、P1 / P2 / 席位、卡池 `xN`、独立详情按钮。
