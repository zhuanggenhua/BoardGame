...
- [ ] 组书 / 法术书编辑器送验前必须运行重复 owner 扫描或等价 DOM / E2E 断言，覆盖 `法术点`、`120 / 120`、所选法师身份、`当前法术书`、`当前法师法术书库`、`编辑当前书`、`更新当前副本`、`给当前书取名`、`新书从当前书`、`当前书内`、`xN`、`席位`、`P1`、`P2`、`兽王标准书`、独立 `详情` 入口、`DIY 法术书`、`空白自组`、`全部卡牌`、第二套范围按钮组等回归词。
