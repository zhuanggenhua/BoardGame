...
- 交叉核验证据：`docs/games/qidahen/workflows/qidahen-hand-card-runtime-atlas-tts-crosswalk.md`
- 本地脚本读取的真实运行时图集：
...
- OCR 尝试记录：`docs/games/qidahen/workflows/qidahen-hand-card-runtime-atlas-ocr-attempt.md`
