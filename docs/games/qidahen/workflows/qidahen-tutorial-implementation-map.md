...
- 主章保留：
  ...
  - `battle-finish`
- 当前链路：
  - 从行动窗口高亮「突袭作战」开始，支付 1 张手牌后进入察哈尔待结算野战，再走战术牌、承伤、战后处理和占领摘要。
...
| :--- | :--- |
| `basic-opening` | `01-12` |
| `attack-and-battle` | `23-27a`（2026-07-14 第二章重构批次：突袭作战、支付、野战、战术牌、承伤、战后处理、占领摘要） |
| `siege-and-occupation` | `30-31a` |
...
- 若后续继续重构第三章及其它章节，必须另起当前章节的玩家链路审查，不得直接复用第二章「突袭作战」答案。
