...
- 辅助 OCR 索引：
  - 批量牌面 OCR 记录：`docs/games/qidahen/workflows/qidahen-hand-card-easyocr-batch-review.md`
  - 关键词分流记录：`docs/games/qidahen/workflows/qidahen-hand-card-ocr-keyword-triage.md`
