...
- 用户后续补充的中文规则 PDF 和两个 Word 已接入 `src/games/betrayal/rule/legacy-zh/`；它们是旧版 / 基础版中文对照源，不覆盖当前 3e 官方规则真相。
...
- PDF 空转证据：`docs/games/betrayal/sources/pdf-text/README.md`
...
- 中文旧版对照源：`src/games/betrayal/rule/legacy-zh/`
