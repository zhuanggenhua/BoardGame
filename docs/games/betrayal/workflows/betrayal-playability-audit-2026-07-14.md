...
物品当前数据合同为 11 个条目，其中 `map / notebook / journal / manuscript` 共享“放置探索者到已发现房间”效果，`flashlight / lantern` 共享事件检定加骰效果。急救包、奇怪的药品、兔脚、头戴耳机和骨制钥匙链不能外推为所有物品使用完成。
...
- 圣符触发作祟判定、圣符探索声明、haunt 阶段禁探索、驱魔失败死亡、急救包/奇怪的药品/地图代表/兔脚/头戴耳机/骨制钥匙等物品链、同房间交易、狗远距交易、面具移动、盔甲物理减伤、骰盘代表链已回到规则真相和真实入口 E2E；剩余范围仍需逐项登记，不得外推成山屋全面完成。
