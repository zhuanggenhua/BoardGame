...
> 来源：从 `docs/ai-rules/engine-systems.md` 无损拆出。本文档承载 `engine/primitives/damageCalculation.ts` 的使用合同；迁移步骤另见 `docs/damage-calculation-pipeline-migration-guide.md`。
