...
根据 Wiki，截至 2026 年 Clowns 促销版发布，共有 **106 个派系**。本报告主体统计生成于 2026-02-28，未整体重算；2026-08-06 已对普通企鹅做增量回写，普通企鹅不再视为“未实现”，当前以 `evidence/smashup/smashup-penguins-closeout-2026-08-06.md` 为准。
...
- 🟢 Penguins（企鹅）- 普通企鹅派系玩法实现与本地验证已收口：15 个唯一卡面、20 张实体牌、2 张基地已接入；22 条能力 L2、4 条集成测试、7 条真实入口 E2E 与 17 张截图已留证。按 2026-08-06 用户口径，远端素材主源上传不属于当前玩法 PR 范围。
- ❌ Sheep（绵羊）- 未实现
- ❌ Mermaids（美人鱼）- 未实现
- ❌ Skeletons（骷髅）- 未实现
