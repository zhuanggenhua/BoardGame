...
- 2026-06-04 回写：`temp/smashup-hera-card-crop-20260604-r5c8/slot-33.webp` 明确写的是“在至多2名仆兵上放置1个战力+1指示物”，没有“你的 / 己方”。本文件旧结论已据此修正。
- 旧实现参考：
...
- `Favor of Hera`：改为玩家多选至多两个任意随从放 +1 指示物；2026-06-04 已补“可选对手随从”的行为测试与 E2E。
...
- `npm run test:e2e:ci:file -- e2e/smashup/smashup-shayu-factions.e2e.ts "Mythic Greeks 赫拉与波塞冬覆盖随从多选和弃牌多选交互"`：2026-06-04 复跑 1 passed，已验证赫拉可选对手随从。
- 新增 Mythic Greeks 玩法截图：
  - `D:\gongzuo\webgame\BoardGame\test-results\evidence-screenshots\_shared\smashup-shayu-factions.e2e\Mythic-Greeks-赫拉与波塞冬覆盖随从多选和弃牌多选交互\shayu-mythic-greeks-hera-after-two-counters.png`
  - `D:\gongzuo\webgame\BoardGame\test-results\evidence-screenshots\_shared\smashup-shayu-factions.e2e\Mythic-Greeks-赫拉与波塞冬覆盖随从多选和弃牌多选交互\shayu-mythic-greeks-poseidon-after-discard-shuffle.png`
- 实际看到：Hera 截图中被选中的两个目标随从上都有 +1 指示物，且 2026-06-04 起该链路已要求至少覆盖一次“对手随从可被选中”；Poseidon 流程结束后无待处理交互，测试断言弃牌选择洗回牌库。
