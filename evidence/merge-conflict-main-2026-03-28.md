# 2026-03-28 `main` 合并冲突记录

## 记录 A：`chore/mobile-adaptive-spec-split`
...
### 解决策略
- 以当前分支的 `cardia` 放大交互与紧凑横屏布局调整为主，吸收 `main` 新增的 `useRuntimeViewport` 公共 hook 和横屏尺寸计算。
...
## 记录 B：`main` 侧 DiceThrone worktree
