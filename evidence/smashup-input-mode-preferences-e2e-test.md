...
## 环境说明
- 本次截图来自 worktree：`D:\gongzuo\webgame\BoardGame-wt-main-push-smashup-20260403`
- 截图场景来自 `/play/smashup` 的 TestHarness 自动配局；验收对象仍然是实际局内悬浮球与设置面板，而不是草稿页或假面板。
...
### 1. 悬浮球设置弹层已打开
- 截图：`D:\gongzuo\webgame\BoardGame-wt-main-push-smashup-20260403\test-results\evidence-screenshots\smashup-local-gameplay.e2e\本地模式：悬浮球设置面板显示-Smash-Up-偏好设置\smashup-settings-panel-open.png`
- 人工观察：
...
### 2. 输入模式偏好区本身
- 截图：`D:\gongzuo\webgame\BoardGame-wt-main-push-smashup-20260403\test-results\evidence-screenshots\smashup-local-gameplay.e2e\本地模式：悬浮球设置面板显示-Smash-Up-偏好设置\smashup-settings-preference-detail.png`
- 人工观察：
