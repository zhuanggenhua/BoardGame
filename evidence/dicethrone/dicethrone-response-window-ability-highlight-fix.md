...
> 2026-06-06 当前有效口径：本文只覆盖“响应窗口切到对手视角后技能不高亮”这一条历史专项修复，不是当前 DiceThrone 所有响应窗口高亮、所有视角切换体验都已彻底收口的证明，也不是新英雄补审出口。阅读时只能把它当作单条高亮修复记录。
...
- `evidence/dicethrone/dicethrone-response-window-view-switch-final-fix.md` - 响应窗口视角切换修复
- `evidence/dicethrone/dicethrone-response-card-highlight-fix.md` - 响应窗口卡牌高亮修复（类似问题）
...
**当前阅读说明**：本文只能证明“响应窗口切到对方视角后技能不高亮”这条专项问题曾被修复，不能外推为当前所有响应技能高亮、所有视角切换逻辑或 DiceThrone 当前整体审计都已收口。
