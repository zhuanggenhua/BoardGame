...
> 2026-06-06 当前有效口径：本文只覆盖“防御方在防御阶段看不到 `Incinerate` 变体技能展示”这一条历史专项修复，不是当前所有变体技能 showcase、所有防御阶段卡牌展示问题都已彻底收口的证明，也不是新英雄补审出口。阅读时只能把它理解成单条 showcase 修复记录。
...
**当前阅读说明**：本文只能证明 `Incinerate` 变体 showcase 显示这条专项问题曾被修复，不能外推为当前所有变体技能展示、所有 attack showcase 映射或 DiceThrone 当前整体审计都已收口。
