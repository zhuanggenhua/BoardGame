...
> 2026-06-06 当前有效口径：本文只覆盖“CRIT 额外伤害被误显示成攻击修正徽章”这一条历史 UI 专项修复证据，不是当前 DiceThrone 所有攻击修正展示问题都已彻底收口的证明，也不是新英雄补审出口。阅读时只能把它理解成单条显示归因修复记录。
...
**当前阅读说明**：本文只能证明“CRIT 不应进入攻击修正徽章”这条专项显示问题曾被修复，不能外推为当前所有 bonus damage 归因、所有攻击修正 UI 或 DiceThrone 当前整体审计都已收口。
