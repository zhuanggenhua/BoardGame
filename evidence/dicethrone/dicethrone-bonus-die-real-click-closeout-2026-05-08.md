...
> 2026-06-06 当前有效口径：本文只覆盖“奖励骰特写必须通过真实点击关闭”这一条专项 closeout 证据，不是当前 DiceThrone 所有奖励骰/特写链路已全面收口的证明，也不是新英雄补审出口。阅读时只能把它当作共享 bonus-die overlay 链路的一份专项验收记录。
...
**当前阅读说明**：本文只能证明“真实点击关闭奖励骰特写”这条专项验收链路曾被补齐，不能外推为当前所有 bonus die 交互、所有角色变体或 DiceThrone 当前整体审计都已收口。
