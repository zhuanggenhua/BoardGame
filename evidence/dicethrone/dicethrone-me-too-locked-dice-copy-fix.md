...
> 2026-06-06 当前有效口径：本文只覆盖“锁定骰子不能作为 `card-me-too` 复制源/目标”这一条历史专项修复，不是当前 DiceThrone 所有复制类改骰交互、所有锁定骰语义都已彻底收口的证明，也不是新英雄补审出口。阅读时只能把它当作单条交互修复记录。
...
**当前阅读说明**：本文只能证明“锁定骰子不能参与 `card-me-too` 复制”这条专项问题曾被修复，不能外推为当前所有复制类改骰交互、所有锁定骰过滤或 DiceThrone 当前整体审计都已收口。
