...
> 2026-06-06 当前有效口径：本文是 2026-03-09 前后的历史恢复计划，只保留当时的恢复假设、排查范围与执行思路，不是当前 DiceThrone 审计任务入口。阅读时必须把它当作历史计划文档；当前真实结论应以 `evidence/_shared/full-reaudit-handoff-2026-03-09.md`、后续专项修复文档，以及新英雄现行主审计文档为准，不得再把本文件当当前待办清单或当前总计划。
