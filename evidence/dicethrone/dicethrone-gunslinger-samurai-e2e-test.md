...
> 2026-06-05 当前有效口径：本文只保留枪手 `Loaded`、武士 `Retribution / Zanshin / Righteousness` 这几条对象级 E2E 复核证据，不代表枪手整英雄、武士整英雄或枪手/武士整批当前完成态。当前若要判断整英雄残余、兄弟能力补审范围或整批发布口径，应以各自单英雄主审计与相关对象级回写文档为准。
