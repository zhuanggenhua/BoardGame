...
> 2026-08-17 更新：本文记录的“闪避骰由共享响应提示按钮确认”已判定为错误修法，只能作为历史坏基线。当前正确合同见 `evidence/dicethrone/dicethrone-token-evasion-right-tray-confirm-2026-08-17.md`：闪避骰进入右侧骰盘后，由右侧骰盘普通“确认”按钮收口，共享响应提示不再承担确认。

## 结论

历史验收状态：PASS；当前口径已被 2026-08-17 新证据取代。
