...
> 2026-06-06 当前有效口径：本文只覆盖“响应窗口视角切换”这一组历史专项修复，不是当前 DiceThrone 所有 response-window 视角、所有高亮/自动跳过体验都已彻底收口的证明，也不是新英雄补审出口。阅读时必须把它理解成一组历史 UI/交互修复记录。
...
**当前阅读说明**：本文只能证明“响应窗口视角切换”这一组专项问题曾被修复，不能外推为当前所有视角切换、高亮、自动跳过链路或 DiceThrone 当前整体审计都已收口。
