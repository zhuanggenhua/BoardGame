...
> 2026-06-06 当前有效口径：本文只保留 Ultimate 伤害不应被护盾抵消这一条共享规则链的专项恢复与验证证据，不代表 DiceThrone 全体规则层、任一单英雄，或四位新英雄整批当前已经审计完成。它现在只能证明当时 `reduceCombat.ts` 里的 Ultimate 护盾免疫逻辑与相关测试被找回，不能外推成更大范围规则链或新英雄补审已经收口。
...
**验证人员**: AI Assistant  
**验证状态**: 当轮专项验证通过
**下一步**: 仅代表当时专项任务的后续动作，不代表当前 DiceThrone 或新英雄整批补审出口

## 当前阅读说明

- 本文是 Ultimate 护盾免疫单链路恢复证据，不是 DiceThrone 当前总审计出口。
