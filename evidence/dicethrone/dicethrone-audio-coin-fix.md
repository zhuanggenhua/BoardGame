...
> 2026-06-06 当前有效口径：本文只记录 DiceThrone/通用音频里一批历史音效修复条目，当前可见内容至少包含“骰子音效误用硬币音色”的专项记录，不是当前 DiceThrone 音频系统或新英雄补审的完成证明。阅读时必须按单条音效修复记录理解，不能把本文外推为“音效问题已全部清空”。
...
**当前阅读说明**：本文只能证明其中记录的个别音效问题曾被修复，不能外推为当前所有 dice/token/ability 音效选择、所有资源映射或 DiceThrone 当前整体审计都已收口。
