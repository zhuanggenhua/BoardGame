...
> 2026-06-06 当前有效口径：本文只记录“首次挂载时游标重复推进导致 ActiveModifierBadge 不显示”这一条历史专项修复，不是当前 DiceThrone 所有游标/事件消费问题都已清空的证明，也不是新英雄补审出口。阅读时必须把它理解成单问题排查记录。
...
**当前阅读说明**：本文只能证明“游标重复推进导致徽章不显示”这条专项问题曾被修复，不能外推为当前所有 EventStream cursor 行为、所有徽章恢复或 DiceThrone 当前整体审计都已收口。
