...
| 确认分配后叛徒胜利 | `D:\gongzuo\webgame\BoardGame\evidence\betrayal-the-dust-ordinary-attack-death\03-确认分配后叛徒胜利.jpg` | 终局页显示剧本“灰尘”，结果为“失败 / 叛徒得逞”；右侧叛徒阵营得胜，杰登作为灰尘叛徒获胜；页面保留攻击投骰复盘，显示造成 4 点伤害。 | 达标：分配确认后才死亡、生成狂热病患并触发叛徒终局。 |
