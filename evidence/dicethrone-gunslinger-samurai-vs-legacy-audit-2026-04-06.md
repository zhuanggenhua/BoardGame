...
- 对比结论：
  ...
  - `左轮速射 II` 本轮额外做了“升级后再点技能槽”的正常对局 E2E，见 `evidence/dicethrone-fan-the-hammer-upgrade-e2e-test-2026-04-06.md`；运行时预期伤害为 `8`，未复现“打出升级卡但技能仍按一级攻击”的问题。
...
- 已补真实在线双人 E2E，见 `evidence/dicethrone-new-passives-e2e-test-2026-04-06.md`：
