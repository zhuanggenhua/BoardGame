...
> 状态提示（2026-06-05）：已归档的历史恢复计划。当前 P0 真实完成口径以 `evidence/_shared/p0-audit-final-complete.md` 等完成文档为准；本文件中的“需要恢复/进行中”只代表 2026-03-04 当时，不得再作为当前待办入口。
...
根据 `evidence/_shared/p0-audit-complete.md`,P0 审计发现:
- **已审计**: 21/26 文件 (81%)
- **需要恢复**: 18/21 文件 (86%)
- **保持删除**: 3/21 文件 (14%)
- **预计恢复行数**: ~3,761 行
