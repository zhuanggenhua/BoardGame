...
- `evidence/_shared/POD-RECOVERY-FINAL-STATUS.md` - 最终恢复状态
- `evidence/dicethrone/POD-RECOVERY-AND-STEALTH-MODE-COMPLETE.md` - 恢复 + 隐身模式
- `evidence/_shared/POD-AUDIT-MISSING-ITEMS.md` - 遗漏项目报告
- `evidence/_shared/POD-AUDIT-RECOVERY-PHASE-2.md` - 第二阶段恢复报告
