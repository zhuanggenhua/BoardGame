...
> 状态提示（2026-06-05）：已归档的历史恢复计划。虽然正文已说明“已废弃/已完成”，但后文仍保留旧的进行中轨迹；当前只能把本文件当历史分析，不得再当默认任务入口。
...
**详细验证报告**：见 `evidence/_shared/p1-verification-complete.md`
...
- `evidence/_shared/p1-audit-batch2-smashup-ui.md` - SmashUp UI 详细审计
- `evidence/_shared/p1-audit-batch3-dicethrone-abilities.md` - DiceThrone 能力详细审计
