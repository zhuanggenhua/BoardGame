...
- 评价弹窗已在 2026-04-09 通过最新复跑并单独落地 `evidence/tictactoe/review-mobile-input-e2e-test.md`。
- 创建房间/私密房间密码链路已在 2026-04-09 通过最新复跑并单独落地 `evidence/_shared/private-room-password-mobile-e2e-test.md`，总表状态同步更新为已收口。
