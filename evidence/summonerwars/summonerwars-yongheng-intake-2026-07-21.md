...
本文件保留为历史录入证据，但其中单位牌 L0 数值版式存在误读：旧合同把部分单位左上费用与右下攻击力互相读反，并把错误结果标为 `locked`。永恒议会后续录入、实现对照和测试期望必须以 `evidence/summonerwars/summonerwars-yongheng-reintake-2026-07-30.md` 为准。
