...
- 已更新 `.codex/skill/game-audit-workflow/SKILL.md`：新增“录入合同状态先于审计路线”门禁。
...
- 已同步更新 `.codex/skill/data-entry-workflow/SKILL.md`、`.codex/skill/game-audit-workflow/SKILL.md` 和 `docs/ai-rules/testing-audit.md`。
...
- 规则更新：`.codex/skill/data-entry-workflow/SKILL.md`、`.codex/skill/game-audit-workflow/SKILL.md`、`docs/ai-rules/data-entry.md` 已补强 `locked` 最小字段清单：对象/实体标识、主真相源定位、完整单对象图或可读裁图、对象归属、规则原文、原子子句、索引/atlas/槽位入口、对照源差异、未决项和状态。缺任一项不得标 `locked`，后续续跑也不得用实现字段、旧测试或 OCR 临时补规则结论。
