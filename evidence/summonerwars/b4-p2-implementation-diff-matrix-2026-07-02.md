...
- B4 五个对象 L4 补证已完成；`infection`、`soul_transfer` 为 `fixed-with-L4-proof`；`life_drain`、`telekinesis_instead` 为 `match-with-L4-proof`；`high_telekinesis_instead` 为 `match-with-L4-representative-proof`。
