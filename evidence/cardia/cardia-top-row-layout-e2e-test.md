...
- `e2e/cardia/cardia-test-scenario-api.e2e.ts`
...
node scripts/infra/run-e2e-command.mjs isolated e2e/cardia/cardia-test-scenario-api.e2e.ts --grep "窄高视口下顶部对手卡应完整显示在战场内|标准视口下卡牌尺寸应保持原版大小"
```
