...
### 1. 拖拽选择态
- 截图：`D:\gongzuo\webgame\BoardGame-wt-main-push-smashup-20260403\test-results\evidence-screenshots\smashup-local-gameplay.e2e\本地模式：拖拽出牌会显示拖拽命中-UI，并在松手后真正落到基地\smashup-drag-selection-ui.png`
- 人工观察：
...
### 2. 松手后的运行态
- 截图：`D:\gongzuo\webgame\BoardGame-wt-main-push-smashup-20260403\test-results\evidence-screenshots\smashup-local-gameplay.e2e\本地模式：拖拽出牌会显示拖拽命中-UI，并在松手后真正落到基地\smashup-drag-play-resolved-ui.png`
- 人工观察：
