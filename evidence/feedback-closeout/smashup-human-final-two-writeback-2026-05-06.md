...
> 2026-05-23 失效说明：
> 本文对反馈 `69fa0bd74590ce09779a7bd6` 的规则判定理由已失效。历史上“已按 `closed` 回写”这一操作事实仍然成立，但其依据“防止被消灭就不应获得标记”已被用户明确推翻。后续若需要继续处理该反馈，必须以 `docs/user-stories/smashup/body-shop-sentence-boundary-2026-05-23.md` 与当前实现/测试口径为准。
