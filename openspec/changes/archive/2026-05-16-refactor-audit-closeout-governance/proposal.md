...
- 现有 `docs/ai-rules/testing-audit.md` 与游戏专项 workflow 虽然写了很多维度，但缺少统一的收口等级、失效回写门禁、以及“哪些证据不能单独作为完成依据”的硬规则。
...
- 为后续实现阶段预留统一落点：更新 `docs/ai-rules/testing-audit.md`、相关游戏 workflow、以及审计 evidence 模板。
