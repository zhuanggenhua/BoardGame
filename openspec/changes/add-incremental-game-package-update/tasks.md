...
- [x] 1.2 确认 `upload-to-server.js` 是当前服务器主源上传入口
...
- [x] 4.3 更新 `asset-pipeline` / Android 发布文档，固化“服务器单文件 + file-index + App 素材包 manifest”单一真相链
