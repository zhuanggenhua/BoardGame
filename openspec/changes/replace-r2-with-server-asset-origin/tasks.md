...
- [x] 1.8 Configure `assets.easyboardgame.top` as grey-cloud direct A record to the server.
- [x] 1.9 Serve `/official/**` directly from server 443 with public TLS and download limits.
- [x] 1.10 Verify public URLs remain available through current domain without R2 and without Worker.
