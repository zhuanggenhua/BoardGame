...
- [x] 2.6 Implement the 2Hand hand-swap stage after chip voting and before round advance/showdown.
...
- [x] 3.6 Add real-card top/bottom hand selection controls for the hand-swap stage.
...
- [x] 4.8 Add domain, AI, action-log, and Board runtime coverage for the hand-swap stage.
- [x] 4.9 Add real-entry screenshot evidence for the hand-swap stage.
