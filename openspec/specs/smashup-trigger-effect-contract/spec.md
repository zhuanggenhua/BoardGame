# smashup-trigger-effect-contract Specification

## Purpose
TBD - created by archiving change refactor-smashup-base-ability-effect-contract-enforcement. Update Purpose after archive.
## Requirements
